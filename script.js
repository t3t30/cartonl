...
// ===== STATE =====
let tipoCert='', cartorioSelecionado='', buscaAtiva=false;
...
function abrirForm(tipo) {
  tipoCert=tipo; cartorioSelecionado=''; buscaAtiva=false;
...
function validarStep(n){
  ...
  if(n===2){
    ...
    if(!buscaAtiva && !cartorioSelecionado){
      const ef=document.getElementById('cartorioError');
...
function renderPreco(){
  ...
  wrap.innerHTML=`
    ...
    ${busca?`<div class="price-row"><span class="price-label">Serviço de busca de cartório</span><span class="price-val extra">+ ${fmt(busca)}</span></div>`:''}
  ...
  el.innerHTML=`
    ...
    <div class="review-section">
      ...
      <div class="review-grid">
        ...
        <div class="review-item"><div class="rlabel">Cartório</div><div class="rvalue">${buscaAtiva?'Serviço de busca ativado':cartorioSelecionado}</div></div>
      </div>
    </div>
    <div class="review-divider"></div>
    <div class="review-section">
    ...
    <div class="review-section">
      ...
      <div class="price-card-wrap">
        <div class="price-row"><span class="price-label">Valor da certidão</span><span class="price-val">${fmt(base)}</span></div>
        ${busca?`<div class="price-row"><span class="price-label">Serviço de busca</span><span class="price-val extra">+ ${fmt(busca)}</span></div>`:''}
